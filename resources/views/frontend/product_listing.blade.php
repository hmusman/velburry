                                    ...
                                    <div class="aiz-card-box border border-light rounded shadow-sm hov-shadow-md has-transition bg-white">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <a href="{{ route('products.category', $sub->slug) }}" class="d-block">
                                                ...
                                                <img class="img-fit mx-auto ls-is-cached lazyloaded" src="{{ uploaded_asset($sub->banner) }}" data-src="" alt="Blue For Men Rasasi cologne for men" onerror="this.onerror=null;this.src='https://velburry.com/public/assets/img/placeholder.jpg';">
